...
namespace _700IQ
{
    ...
    public class CustomScrollbar : UserControl
    {
        ...
        public CustomScrollbar()
        {
            ...
            UpArrowImage =  Properties.Resources.SB_up;
            DownArrowImage = Properties.Resources.SB_down;
           ...
           /* ThumbBottomImage = Properties.Resources.ThumbBottom;
            ...
            ThumbMiddleImage = Properties.Resources.SB_center;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
           ...
           // e.Graphics.FillRectangle(oBrush, new Rectangle(1, UpArrowImage.Height, this.Width - 2, (this.Height - DownArrowImage.Height)));
            ...
            float fSpanHeight = (fThumbHeight - (ThumbMiddleImage.Height)) / 2.0f;
